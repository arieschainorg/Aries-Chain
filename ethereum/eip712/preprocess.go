...
// PreprocessLedgerTx reformats Ledger-signed Cosmos transactions to match the fork expected by Aries Chain
...
func PreprocessLedgerTx(evmChainID uint64, keyType cosmoskr.KeyType, txBuilder client.TxBuilder) error {
	...
	// (Regardless of input signMode, Aries Chain requires Amino signature type for Ledger)
