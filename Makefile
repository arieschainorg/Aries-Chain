...
EXAMPLE_BINARY := ariesd

###############################################################################
###                              Repo Info                                  ###
###############################################################################

HTTPS_GIT := https://github.com/arieschainorg/Aries-Chain.git
...
PACKAGE_NAME:=github.com/arieschainorg/Aries-Chain
...
# Install the necessary dependencies, compile the solidity contracts found in
# this repository and then clean up the contracts data.
...
# Compile the solidity contracts found in this repository.
contracts-compile:
...
localnet-build-nodes:
	$(DOCKER) run --rm -v $(CURDIR)/.testnets:/data ariesd \
