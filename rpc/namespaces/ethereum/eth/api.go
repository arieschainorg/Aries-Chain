...
import (
	...
	evmtrace "github.com/arieschainorg/Aries-Chain/trace"
...
// The Ethereum API allows applications to connect to an node of any Aries Chain based blockchain.
...
// GasPrice returns the current gas price based on Aries Chain's gas price oracle.
