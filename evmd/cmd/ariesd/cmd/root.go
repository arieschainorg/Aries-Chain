...
import (
	...
	cosmosevmcmd "github.com/arieschainorg/Aries-Chain/client"
	evmdebug "github.com/arieschainorg/Aries-Chain/client/debug"
	"github.com/arieschainorg/Aries-Chain/crypto/hd"
	"github.com/arieschainorg/Aries-Chain/evmd"
	"github.com/arieschainorg/Aries-Chain/evmd/config"
...
func initRootCmd(rootCmd *cobra.Command, evmApp *evmd.EVMD) {
	...
	// add Aries Chain's flavored TM commands to start server, etc.
