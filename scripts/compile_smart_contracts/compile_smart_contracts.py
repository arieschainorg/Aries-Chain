...
# The path to the main level of the Aries Chain repository.
...
def is_os_repo(path: Path) -> bool:
    """
    This function checks if the given path is the root of the Aries Chain repository,
    ...
    with open(path / "go.mod", "r", encoding="utf-8") as go_mod:
        while True:
            ...
            if "module github.com/arieschainorg/Aries-Chain" in line:
                return True
