...
1. **Issue Link Required**
   - All pull requests must be linked to an existing [GitHub Issue](https://github.com/arieschainorg/Aries-Chain/issues).
...
Thank you for helping improve Aries Chain!
