...
import (
	...
	bank2 "github.com/arieschainorg/Aries-Chain/precompiles/bank"
	"github.com/arieschainorg/Aries-Chain/precompiles/bank/testdata"
	...
	_ = Describe("Bank Extension -", func() {
		...
		Context("Direct precompile queries", func() {
			...
			Context("supplyOf query", func() {
				It("should return the supply of Aries Chain", func() {
