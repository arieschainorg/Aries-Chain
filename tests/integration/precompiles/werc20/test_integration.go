...
import (
	...
	"github.com/arieschainorg/Aries-Chain/precompiles/erc20"
	"github.com/arieschainorg/Aries-Chain/precompiles/testutil"
	"github.com/arieschainorg/Aries-Chain/precompiles/werc20"
	"github.com/arieschainorg/Aries-Chain/precompiles/werc20/testdata"
	testconstants "github.com/arieschainorg/Aries-Chain/testutil/constants"
	"github.com/arieschainorg/Aries-Chain/testutil/integration/evm/factory"
	"github.com/arieschainorg/Aries-Chain/testutil/integration/evm/grpc"
	"github.com/arieschainorg/Aries-Chain/testutil/integration/evm/network"
	"github.com/arieschainorg/Aries-Chain/testutil/keyring"
	utiltx "github.com/arieschainorg/Aries-Chain/testutil/tx"
	testutiltypes "github.com/arieschainorg/Aries-Chain/testutil/types"
		...
		Context("calling an erc20 method", func() {
			...
			When("querying information", func() {
				...
				It("should return the correct name", func() {
					...
					Expect(err).ToNot(HaveOccurred(), "failed to unpack result")
					Expect(name).To(ContainSubstring("Aries Chain"), "expected different name")
				})
