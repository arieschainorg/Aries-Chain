...
import (
	ns "github.com/arieschainorg/Aries-Chain/tests/jsonrpc/simulator/namespaces"
	"github.com/arieschainorg/Aries-Chain/tests/jsonrpc/simulator/types"
	"github.com/arieschainorg/Aries-Chain/tests/jsonrpc/simulator/utils"
)
		...
		},
		{
			...
			Methods: []types.TestMethod{
				...
				{Name: ns.MethodNamePersonalInitializeWallet, Handler: func(_ *types.RPCContext) (*types.RpcResult, error) {
					return utils.Skip(ns.MethodNamePersonalInitializeWallet, "personal", "Aries Chain always returns false for personal namespace methods")
				}},
				{Name: ns.MethodNamePersonalUnpair, Handler: func(_ *types.RPCContext) (*types.RpcResult, error) {
					return utils.Skip(ns.MethodNamePersonalUnpair, "personal", "Aries Chain always returns false for personal namespace methods")
				}},
				...
				{Name: ns.MethodNamePersonalUnlockAccount, Handler: func(_ *types.RPCContext) (*types.RpcResult, error) {
					return utils.Skip(ns.MethodNamePersonalUnlockAccount, "personal", "Aries Chain always returns false for personal namespace methods")
				}},
				{Name: ns.MethodNamePersonalLockAccount, Handler: func(_ *types.RPCContext) (*types.RpcResult, error) {
					return utils.Skip(ns.MethodNamePersonalLockAccount, "personal", "Aries Chain always returns false for personal namespace methods")
				}},
				// Signing subcategory
