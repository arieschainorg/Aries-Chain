...
This directory contains tools and scripts for testing JSON-RPC API compatibility between Aries Chain and Ethereum clients.
...
- Check if the Docker image was built: `docker images | grep ariesd`
